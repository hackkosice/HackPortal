...
INSERT INTO "new_FormField" ("createdAt", "description", "id", "label", "name", "optionListId", "position", "required", "shownInList", "stepId", "typeId", "updatedAt") SELECT "createdAt", "description", "id", "label", "name", "optionListId", "position", "required", "shownInList", "stepId", "typeId", "updatedAt" FROM "FormField";
