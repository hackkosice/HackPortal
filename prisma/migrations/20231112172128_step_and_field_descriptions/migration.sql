-- AlterTable
ALTER TABLE "ApplicationFormStep" ADD COLUMN "description" TEXT;
...
INSERT INTO "new_FormField" ("createdAt", "id", "label", "name", "optionListId", "position", "required", "stepId", "typeId", "updatedAt") SELECT "createdAt", "id", "label", "name", "optionListId", "position", "required", "stepId", "typeId", "updatedAt" FROM "FormField";
