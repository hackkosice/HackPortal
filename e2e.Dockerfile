...
ENV NEXT_PUBLIC_SENTRY_DSN test-sentry
...
ENV NEXT_PUBLIC_DATADOG_ENABLED false
ENV NEXT_PUBLIC_DATADOG_CLIENT_TOKEN test-datadog
ENV NEXT_PUBLIC_DATADOG_SITE test-datadog
ENV NEXT_PUBLIC_LOG_DEBUG false
